...
namespace NexaSoft.Club.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251013043431_InitCreated")]
            ...
            modelBuilder.Entity("NexaSoft.Club.Domain.Features.Reservations.Reservation", b =>
                {
                    ...
                    b.HasIndex("PaymentTypeId")
                        .HasDatabaseName("ix_reservations_payment_type_id");
            ...
            modelBuilder.Entity("NexaSoft.Club.Domain.Masters.SpaceAvailabilities.SpaceAvailability", b =>
                {
                    ...
                    b.Property<int>("MaxReservationDaysInAdvance")
                        .HasColumnType("integer")
                        .HasColumnName("max_reservation_days_in_advance");

                    b.Property<int?>("MaxReservationsPerDay")
                        .HasColumnType("integer")
                        .HasColumnName("max_reservations_per_day");

                    b.Property<int>("MinReservationHours")
                        .HasColumnType("integer")
                        .HasColumnName("min_reservation_hours");
            ...
            modelBuilder.Entity("NexaSoft.Club.Domain.Features.Reservations.Reservation", b =>
                {
                    ...
                    b.HasOne("NexaSoft.Club.Domain.Masters.PaymentTypes.PaymentType", "PaymentType")
                        ...
                        .HasConstraintName("fk_reservations_payment_types_payment_type_id");
