...
public class EventoRegulatorioCreateDomainEventHandler(
...
) : INotificationHandler<EventoRegulatorioCreateDomainEvent>
{
    public async Task Handle(EventoRegulatorioCreateDomainEvent notification, CancellationToken cancellationToken)
    {
        ...
        if (entity is not null)
        {
            ...
            var emailMessage = new EmailMessage
            {
                ...
                Subject = $"📋 Evento Regulatorio creado {entity.TipoEvento} - Atención Requerida",
                HtmlContent = _templateService.GenerateCustomTemplate(
                    new TemplateData
                    {
                        ...
                        MainContent = $@"Se ha creado un evento regulatorio que requiere su revisión inmediata. 
