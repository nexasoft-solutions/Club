...
public class PayrollStatusTypeSpecification : BaseSpecification<PayrollStatusType, PayrollStatusTypeResponse>
{
    public BaseSpecParams SpecParams { get; }

    public PayrollStatusTypeSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new PayrollStatusTypeResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Description,
