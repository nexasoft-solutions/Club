...
public class CostCenterTypeSpecification : BaseSpecification<CostCenterType, CostCenterTypeResponse>
{
    public BaseSpecParams SpecParams { get; }

    public CostCenterTypeSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new CostCenterTypeResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Description,
