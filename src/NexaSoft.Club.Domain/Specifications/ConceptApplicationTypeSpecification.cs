...
public class ConceptApplicationTypeSpecification : BaseSpecification<ConceptApplicationType, ConceptApplicationTypeResponse>
{
    public BaseSpecParams SpecParams { get; }

    public ConceptApplicationTypeSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new ConceptApplicationTypeResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Description,
