...
public class PayrollTypeSpecification : BaseSpecification<PayrollType, PayrollTypeResponse>
{
    public BaseSpecParams SpecParams { get; }

    public PayrollTypeSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new PayrollTypeResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Description,
