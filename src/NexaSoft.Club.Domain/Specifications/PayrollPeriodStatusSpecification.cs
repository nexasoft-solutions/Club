...
public class PayrollPeriodStatusSpecification : BaseSpecification<PayrollPeriodStatus, PayrollPeriodStatusResponse>
{
    public BaseSpecParams SpecParams { get; }

    public PayrollPeriodStatusSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new PayrollPeriodStatusResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Description,
