...
public class RateTypeSpecification : BaseSpecification<RateType, RateTypeResponse>
{
    public BaseSpecParams SpecParams { get; }

    public RateTypeSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new RateTypeResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Description,
