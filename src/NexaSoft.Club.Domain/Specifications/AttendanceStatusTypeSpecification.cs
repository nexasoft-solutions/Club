...
public class AttendanceStatusTypeSpecification : BaseSpecification<AttendanceStatusType, AttendanceStatusTypeResponse>
{
    public BaseSpecParams SpecParams { get; }

    public AttendanceStatusTypeSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new AttendanceStatusTypeResponse(
             x.Id,
             x.Code,
             x.Name,
             x.IsPaid,
