...
public class CurrencySpecification : BaseSpecification<Currency, CurrencyResponse>
{
    public BaseSpecParams SpecParams { get; }

    public CurrencySpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new CurrencyResponse(
             x.Id,
             x.Code,
             x.Name,
             x.CreatedAt,
