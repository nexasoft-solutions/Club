...
public class PayrollFormulaSpecification : BaseSpecification<PayrollFormula, PayrollFormulaResponse>
{
    public BaseSpecParams SpecParams { get; }

    public PayrollFormulaSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new PayrollFormulaResponse(
             x.Id,
             x.Code,
             x.Name,
             x.FormulaExpression,
