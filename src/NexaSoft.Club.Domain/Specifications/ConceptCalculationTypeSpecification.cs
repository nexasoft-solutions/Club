...
public class ConceptCalculationTypeSpecification : BaseSpecification<ConceptCalculationType, ConceptCalculationTypeResponse>
{
    public BaseSpecParams SpecParams { get; }

    public ConceptCalculationTypeSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new ConceptCalculationTypeResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Description,
