...
public class PaymentMethodTypeSpecification : BaseSpecification<PaymentMethodType, PaymentMethodTypeResponse>
{
    public BaseSpecParams SpecParams { get; }

    public PaymentMethodTypeSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new PaymentMethodTypeResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Description,
