...
public class LegalParameterSpecification : BaseSpecification<LegalParameter, LegalParameterResponse>
{
    public BaseSpecParams SpecParams { get; }

    public LegalParameterSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new LegalParameterResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Value,
