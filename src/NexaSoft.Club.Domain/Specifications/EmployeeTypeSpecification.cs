...
public class EmployeeTypeSpecification : BaseSpecification<EmployeeType, EmployeeTypeResponse>
{
    public BaseSpecParams SpecParams { get; }

    public EmployeeTypeSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new EmployeeTypeResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Description,
