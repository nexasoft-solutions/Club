...
public class ConceptTypePayrollSpecification : BaseSpecification<ConceptTypePayroll, ConceptTypePayrollResponse>
{
    public BaseSpecParams SpecParams { get; }

    public ConceptTypePayrollSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new ConceptTypePayrollResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Description,
