...
public class TimeRequestTypeSpecification : BaseSpecification<TimeRequestType, TimeRequestTypeResponse>
{
    public BaseSpecParams SpecParams { get; }

    public TimeRequestTypeSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new TimeRequestTypeResponse(
             x.Id,
             x.Code,
             x.Name,
             x.DeductsSalary,
