...
public class ContractTypeSpecification : BaseSpecification<ContractType, ContractTypeResponse>
{
    public BaseSpecParams SpecParams { get; }

    public ContractTypeSpecification(BaseSpecParams specParams) : base()
    {
    ...
    else
    {
      ...
      AddSelect(x => new ContractTypeResponse(
             x.Id,
             x.Code,
             x.Name,
             x.Description,
