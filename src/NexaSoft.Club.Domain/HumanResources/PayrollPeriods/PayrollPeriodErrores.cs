...
public class PayrollPeriodErrores
{
    ...
    public static readonly Error Duplicado = new(
        ...
        "Ya existe un período de planilla con el mismo nombre");

    public static readonly Error FechasInvalidas = new(
        "PayrollPeriod.FechasInvalidas", 
        "Las fechas del período son inválidas");

    public static readonly Error PeriodoSolapado = new(
        "PayrollPeriod.PeriodoSolapado", 
        "El período se solapa con otro período existente");
