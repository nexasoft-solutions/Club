...
public class SourceModuleController(ISender _sender) : ControllerBase
{
    ...
    [HttpPost]
    [GeneratePermission]
    [RequirePermission("SourceModule.CreateSourceModule")]
    ...
    [HttpPut]
    [GeneratePermission]
    [RequirePermission("SourceModule.UpdateSourceModule")]
    ...
    [HttpDelete]
    [GeneratePermission]
    [RequirePermission("SourceModule.DeleteSourceModule")]
    ...
    [HttpGet]
    [GeneratePermission]
    [RequirePermission("SourceModule.GetSourceModules")]
    ...
    [HttpGet("{id:long}")]
    [GeneratePermission]
    [RequirePermission("SourceModule.GetSourceModule")]
