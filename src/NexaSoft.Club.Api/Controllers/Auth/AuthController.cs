...
using NexaSoft.Club.Application.Masters.Auths.Queries.ChangeActiveRole;
using NexaSoft.Club.Application.Masters.Auths.Queries.RefreshTokens;

namespace NexaSoft.Club.Api.Controllers.Auth
{
