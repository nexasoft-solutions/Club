...
using NexaSoft.Agro.Api.Controllers.Masters.Permissions.Request;
using NexaSoft.Agro.Api.Extensions;
using NexaSoft.Agro.Application.Features.Admins.SincronizarPermisos;
using NexaSoft.Agro.Application.Masters.Permissions.Commands.CreatePermision;
using NexaSoft.Agro.Application.Masters.Permissions.Commands.CreatePermission;
using NexaSoft.Agro.Application.Masters.Permissions.Commands.DeletePermission;
using NexaSoft.Agro.Application.Masters.Permissions.Queries.GetPermissions;
using NexaSoft.Agro.Application.Masters.Permissions.Queries.GetRolesPermissions;

namespace NexaSoft.Agro.Api.Controllers.Masters.Permissions
{
