...
using NexaSoft.Agro.Api.Controllers.Masters.Roles.Request;
using NexaSoft.Agro.Api.Extensions;
using NexaSoft.Agro.Application.Masters.Permissions.Commands.AssignPermissionToRole;
using NexaSoft.Agro.Application.Masters.Permissions.Commands.RevokePermissionFromRole;
using NexaSoft.Agro.Application.Masters.Roles.Commands.CreateRole;
using NexaSoft.Agro.Application.Masters.Roles.Commands.DeleteRole;
using NexaSoft.Agro.Application.Masters.Roles.Queries.GetRoles;

namespace NexaSoft.Agro.Api.Controllers.Masters.Roles
{
